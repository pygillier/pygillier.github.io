...
BLOG_AUTHOR = "Pierre-Yves Gillier"  # (translatable)
BLOG_TITLE = "pygillier.dev"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://pygillier.dev/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://pygillier.dev/"
BLOG_EMAIL = "github@pygillier.me"
BLOG_DESCRIPTION = "Random code & snippets"  # (translatable)
